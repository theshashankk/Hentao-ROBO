...
PM_START_TEXT = """*Hey there, my name is Hentai\n\nI am a next gen powerful group manager bot.\n\nHit /help to find my list of available commands\n\n Mentained BY @TheShashank 😎🔥.*"""
buttons = [
    [
    ...
    [
        InlineKeyboardButton(
            text="➕ Add me to your group ➕", url="t.me/TheHentai_RoBoT?startgroup=true"
        ),
    ],
]

HELP_STRINGS = """
Hey there! My name is *Hentai*.😎🔥
